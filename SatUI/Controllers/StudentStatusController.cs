...
namespace SatUI.Controllers
{
    public class StudentStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentStatusID,StatusName,StatusDescription")] StudentStatus studentStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentStatusID,StatusName,StatusDescription")] StudentStatus studentStatus)
        {
            if (ModelState.IsValid)
            {
